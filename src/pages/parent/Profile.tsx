...
import { Camera, Mail, Phone, MapPin, Shield, Save, Users } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="lg:col-span-1">
          <CardContent className="pt-6 text-center">
            ...
            <div className="mt-2 inline-flex items-center gap-1 px-3 py-1 rounded-full bg-amber-100 text-amber-700 text-sm">
        ...
        <Card className="lg:col-span-2">
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <Label>Address</Label>
                <Input defaultValue="123 Main Street, District - 123456" />
              </div>

              <div className="space-y-2">
                <Label>Emergency Contact</Label>
                <Input defaultValue="9876543231" />
              </div>
